...
## Project: dr-chrono-mcp

## Overview

A Model Context Protocol (MCP) server for the [DrChrono](https://www.drchrono.com/) healthcare API, providing tools for patient management, appointments, clinical notes, billing, and FHIR R4 interoperability. - **OAuth 2.0 Authentication** - Secure authorization flow with automatic token refresh
